...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-fiji-address-settlement.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/fiji-address-settlement"
      },
      "name" : "Fiji Settlement",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-fiji-address-province.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/fiji-address-province"
      },
      "name" : "Fiji Yasana or Province",
