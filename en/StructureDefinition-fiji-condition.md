# Fiji Condition - Draft Fiji Core Implementation Guide v0.2.1
...
* Examples for this Profile: [Condition/condition-example-diabetes2](Condition-condition-example-diabetes2.md)
