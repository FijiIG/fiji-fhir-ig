# Fiji Immunization - Draft Fiji Core Implementation Guide v0.2.0
...
* Examples for this Profile: [Immunization/FijiImmunizationReactionExample](Immunization-FijiImmunizationReactionExample.md) and [Immunization/FijiTdapImmunizationExample](Immunization-FijiTdapImmunizationExample.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "https://core.fhir.health.gov.fj/ValueSet/fiji-medication-route-vs"
      }
    },
    {
    ...
    },
    {
      ...
      "short" : "Details of an adverse reaction that follows immunization",
      "max" : "1"
    },
    {
      "id" : "Immunization.reaction.date",
      "path" : "Immunization.reaction.date",
      "short" : "When adverse reaction started",
      "min" : 1,
      "mustSupport" : true
    },
    {
      ...
      "short" : "Observation detail of adverse reaction",
      "min" : 1,
      "mustSupport" : true
    }]
  }
