# Example Total Cholesterol - Draft Fiji Core Implementation Guide v0.2.1

## Example Observation: Example Total Cholesterol
...
**value**: 4.8 mmol/L (Details: UCUM codemmol/L = 'mmol/L')
