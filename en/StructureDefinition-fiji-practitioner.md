# Fiji Practitioner - Draft Fiji Core Implementation Guide v0.2.0
...
* Refer to this Profile: [Fiji Allergy/Intolerance](StructureDefinition-fiji-allergy-intolerance.md), [Fiji Diagnostic Observation](StructureDefinition-fiji-diagnostic-observation.md), [Fiji Immunization](StructureDefinition-fiji-immunization.md), [Fiji Pathology Observation](StructureDefinition-fiji-pathology-observation.md)... Show 2 more, [Fiji Patient](StructureDefinition-fiji-patient.md) and [Fiji Practitioner Role](StructureDefinition-fiji-practitioner-role.md)
