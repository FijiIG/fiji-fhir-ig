# Fiji Pathology Observation - Draft Fiji Core Implementation Guide v0.2.0
...
* Examples for this Profile: [Observation/ExampleArterialPO2](Observation-ExampleArterialPO2.md)
