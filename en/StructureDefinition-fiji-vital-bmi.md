# BMI Vitals - Fiji - Draft Fiji Core Implementation Guide v0.2.0

## Resource Profile: BMI Vitals - Fiji 

 
This profile defines the requirements and usage of an Observation resource recording BMI vital observations. It is based on the FHIR BMI Profile and adapted as required for the Fiji Core Implementation Guide. 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/health.gov.fhir.fj.core|current/StructureDefinition/StructureDefinition-fiji-vital-bmi.json)
...
Other representations of profile: [CSV](../StructureDefinition-fiji-vital-bmi.csv), [Excel](../StructureDefinition-fiji-vital-bmi.xlsx), [Schematron](../StructureDefinition-fiji-vital-bmi.sch) 
...
```json
{
  ...
  "id" : "fiji-vital-bmi",
  "url" : "https://core.fhir.health.gov.fj/StructureDefinition/fiji-vital-bmi",
  "version" : "0.2.0",
  "name" : "FijiBMI",
