# Head circumference Vitals - Fiji - Draft Fiji Core Implementation Guide v0.2.0

## Resource Profile: Head circumference Vitals - Fiji 

 
This profile defines the requirements and usage of an Observation resource recording Head Circumference. It is based on the FHIR Head Circumference Profile and adapted as required for the Fiji Core Implementation Guide. 
...
* Examples for this Profile: [Observation/FijiHeadCircumferenceExample](Observation-FijiHeadCircumferenceExample.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/health.gov.fhir.fj.core|current/StructureDefinition/StructureDefinition-fiji-vital-head-circumference.json)
...
Other representations of profile: [CSV](../StructureDefinition-fiji-vital-head-circumference.csv), [Excel](../StructureDefinition-fiji-vital-head-circumference.xlsx), [Schematron](../StructureDefinition-fiji-vital-head-circumference.sch) 
...
```json
{
  ...
  "url" : "https://core.fhir.health.gov.fj/StructureDefinition/fiji-vital-head-circumference",
  "version" : "0.2.0",
  "name" : "FijiHeadCircumference",
