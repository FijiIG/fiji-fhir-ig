...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://core.fhir.health.gov.fj/StructureDefinition/fiji-patient-occupation']) &lt;= 1">extension with URL = 'https://core.fhir.health.gov.fj/StructureDefinition/fiji-patient-occupation': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://core.fhir.health.gov.fj/StructureDefinition/fiji-patient-ethnicity']) &lt;= 1">extension with URL = 'https://core.fhir.health.gov.fj/StructureDefinition/fiji-patient-ethnicity': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:birthDate">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://core.fhir.health.gov.fj/StructureDefinition/birthdate-estimated-indicator']) &lt;= 1">extension with URL = 'https://core.fhir.health.gov.fj/StructureDefinition/birthdate-estimated-indicator': maximum cardinality of 'extension' is 1</sch:assert>
