...
Alias: $patient-occupation-nz = http://hl7.org.nz/fhir/StructureDefinition/acc-patient-occupation
Alias: $patient-ethnicity-nz = http://hl7.org.nz/fhir/StructureDefinition/nz-ethnicity
